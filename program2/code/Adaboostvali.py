...
from dataprocess import splitdata, svd
...
neigh1 = AdaBoostClassifier(n_estimators=50, learning_rate=0.5)
neigh2 = AdaBoostClassifier(n_estimators=50, learning_rate=0.5)
neigh3 = AdaBoostClassifier(n_estimators=50, learning_rate=0.5)
