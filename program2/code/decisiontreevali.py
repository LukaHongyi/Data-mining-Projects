...
neigh1 = DecisionTreeClassifier(min_samples_split=7,min_samples_leaf=4)
neigh2 = DecisionTreeClassifier(min_samples_split=7,min_samples_leaf=4)
neigh3 = DecisionTreeClassifier(min_samples_split=7,min_samples_leaf=4)
