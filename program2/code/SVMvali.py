...
import sklearn
from dataprocess import highcorr, splitdata
...
dataMY = highcorr(dataMY)
dataBO = highcorr(dataBO)
dataHK = highcorr(dataHK)
X1 = dataMY.iloc[:,1:]
Y1 = dataMY.iloc[:,0]
...
neigh1 = sklearn.svm.SVC(C=3,kernel="rbf")
neigh2 = sklearn.svm.SVC(C=3,kernel="rbf")
neigh3 = sklearn.svm.SVC(C=3,kernel="rbf")
