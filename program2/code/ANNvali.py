...
from dataprocess import pca, splitdata
...
neigh1 = MLPClassifier(hidden_layer_sizes=(400,100),alpha=0.01,max_iter=100,activation="relu")
neigh2 = MLPClassifier(hidden_layer_sizes=(400,100),alpha=0.01,max_iter=100,activation="relu")
neigh3 = MLPClassifier(hidden_layer_sizes=(400,100),alpha=0.01,max_iter=100,activation="relu")
