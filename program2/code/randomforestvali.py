...
from dataprocess import IOSMAP, splitdata
...
neigh1 = RandomForestClassifier(min_samples_split=7,min_samples_leaf=1)
neigh2 = RandomForestClassifier(min_samples_split=7,min_samples_leaf=1)
neigh3 = RandomForestClassifier(min_samples_split=7,min_samples_leaf=1)
