...
from dataprocess import ica, splitdata
...
neigh1 = LogisticRegression(max_iter=500, solver="newton-cg")
neigh2 = LogisticRegression(max_iter=500, solver="newton-cg")
neigh3 = LogisticRegression(max_iter=500, solver="newton-cg")
