...
from dataprocess import factorAnalysis, splitdata
...
dataMY = factorAnalysis(dataMY)
dataBO = factorAnalysis(dataBO)
dataHK = factorAnalysis(dataHK)
...
for metricarr in metricarrs:
    neigh1 = DecisionTreeClassifier(min_samples_split=metricarr[0],min_samples_leaf=metricarr[1])
    neigh2 = DecisionTreeClassifier(min_samples_split=metricarr[0],min_samples_leaf=metricarr[1])
    neigh3 = DecisionTreeClassifier(min_samples_split=metricarr[0],min_samples_leaf=metricarr[1])
